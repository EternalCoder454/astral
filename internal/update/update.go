// Package update checks whether a newer Astral has been published, and
...
const DefaultNotesURL = "https://raw.githubusercontent.com/EternalCoder454/astral/%s/WHATSNEW.md"
...
func ParseNotes(r io.Reader) (*Release, error) {
	...
	for scanner.Scan() {
		...
		case strings.HasPrefix(line, "## "):
			...
			// "## 9.9.9 and your world is corrupt, see ..." carried all of
